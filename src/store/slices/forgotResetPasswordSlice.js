...
export const forgotPassword = (email) => async (dispatch) => {
  try {
    ...
    const response = await axios.post(
      "https://mern-portfolio-backend-49mp.onrender.com/api/v1/user/password/forgot",
      { email },
  ...
  (token, password, confirmPassword) => async (dispatch) => {
    try {
      ...
      const response = await axios.put(
        ` https://mern-portfolio-backend-49mp.onrender.com/api/v1/user/password/reset/${token}`,
